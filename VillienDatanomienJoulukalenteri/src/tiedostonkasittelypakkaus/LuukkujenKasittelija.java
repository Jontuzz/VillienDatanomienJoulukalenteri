...
public class LuukkujenKasittelija {
    ...
    public boolean kirjoitaLuukutJsonTiedostoon() {
        ...
        luukkuLista.put("luukku12", new Luukku("luukku12", 12, false, paivayksenHallinta.parseDate("12/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku13", new Luukku("luukku13", 13, false, paivayksenHallinta.parseDate("13/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku14", new Luukku("luukku14", 14, false, paivayksenHallinta.parseDate("14/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku15", new Luukku("luukku15", 15, false, paivayksenHallinta.parseDate("15/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku16", new Luukku("luukku16", 16, false, paivayksenHallinta.parseDate("16/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku17", new Luukku("luukku17", 17, false, paivayksenHallinta.parseDate("17/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
        luukkuLista.put("luukku18", new Luukku("luukku18", 18, false, paivayksenHallinta.parseDate("18/11/2017"), "Hyvää joulua ja onnellista uutta vuotta!", "file:///C:/Users/s1601378/Downloads/MELANKOLIA.mp3"));
...
//            }
    ...
    public boolean avaaLuukku(String luukunNimi) {
        ...
        if (voikoLuukunAvata(luukunNimi)) {
            ...
            luukkuLista.put("luukku" + luukkuLista.get(luukunNimi).getNumero(), new Luukku("luukku" + luukkuLista.get(luukunNimi).getNumero(), luukkuLista.get(luukunNimi).getNumero(), true, paivayksenHallinta.parseDate(luukkuLista.get(luukunNimi).getNumero() + "/11/2017"), luukkuLista.get(luukunNimi).getSisalto(), luukkuLista.get(luukunNimi).getMusiikkiTiedostoPolku()));
